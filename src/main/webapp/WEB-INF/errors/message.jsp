            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        <div class="error mx-auto">Error</div>
                        <p class="lead text-gray-800 mb-5">경고 : ${errMsg} </p>
                        <p class="text-gray-500 mb-0">The requested operation was not processed. Please check.</p>
                        <a href="../home/index">&larr; Back to Dashboard</a>
                    </div>
